                        ...
                        <form>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    <input type="mobile" className="form-control" id="inputMobile" placeholder="Mobile" />
                                </div>
                            </div>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    <input type="country" className="form-control" id="inputCountry" placeholder="Country / Region" />
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-6">
